...
User follower1 = new User(
    'the_rock', AssetImage('lib/assets/follower3.jpeg'), [], [], [], [], true);
User follower2 = new User('miley_cyrus', AssetImage('lib/assets/follower2.jpg'),
    [], [], [], [], false);
User follower3 = new User(
    'kim_k', AssetImage('lib/assets/their_profile.jpeg'), [], [], [], [], true);
User follower4 = new User(
    'daredevil', AssetImage('lib/assets/profile3.png'), [], [], [], [], true);
User follower5 = new User(
    'batman', AssetImage('lib/assets/profile6.jpg'), [], [], [], [], true);
